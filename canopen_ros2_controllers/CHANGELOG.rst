...
* synch humble
* Removed Cia402RobotController from canopen_ros2_controllers.xml (`#221 <https://github.com/ros-industrial/ros2_canopen/issues/221>`_)
  After the refactor of Cia402RobotController code the xml was not updated. `#211 <https://github.com/ros-industrial/ros2_canopen/issues/211>`_
* 0.2.7
* Update changelog
