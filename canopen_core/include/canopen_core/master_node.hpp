...
public:
  MasterNode(const rclcpp::NodeOptions & node_options) : MasterInterface("master", node_options) {}
  ...
  /**
         ...
         */
  void add_driver(
    std::shared_ptr<ros2_canopen::DriverInterface> node_instance, uint8_t node_id) override;
