...
private:
  ...
  /**
         ...
         * @return unsigned int
         */
  unsigned int get_state(uint8_t node_id, std::chrono::seconds time_out = 3s);
  ...
  /**
         ...
         * @return false
         */
  bool change_state(uint8_t node_id, uint8_t transition, std::chrono::seconds time_out = 3s);
  ...
  /**
         ...
         * @return false
         */
  bool bring_up_driver(std::string device_name);
  ...
  /**
         ...
         * @return false
         */
  bool bring_down_driver(std::string device_name);
