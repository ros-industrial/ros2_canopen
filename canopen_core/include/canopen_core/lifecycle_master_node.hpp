...
public:
  /**
         ...
         * @param node_options
         */
  LifecycleMasterNode(const rclcpp::NodeOptions & node_options)
  ...
  /**
         ...
         *
         * This reads the nodes parameters.
         *
         * @param state
  ...
  /**
         ...
         */
  void init_driver(
    std::shared_ptr<ros2_canopen::LifecycleDriverInterface> node_instance,
    uint8_t node_id) override;
